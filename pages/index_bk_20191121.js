...
const DEdata = dataFromTool.filter(row =>row.eqp_id==='3DE-02')
console.log(DEdata)


console.log(dataFromTool)
let datas = orderBy(DEdata,['inserted_timestamp']) //order desc by reporting date
